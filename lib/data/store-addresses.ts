...
export const storeAddresses: StoreAddress[] = [
  ...
  {
    id: "store_pryvokzalnyi_006_126",
    name: "Магазин Привокзальний 6/126",
    city: "Житомир",
    district: "Привокзальний",
    address: "м. Житомир, Привокзальний майдан, 6/126",
    aliases: ["Привокзальний 6/126", "Привокзальний 6 126", "Привокзальний, 6/126", "магазин Привокзальний"],
    objectType: "store",
  },
  {
    id: "store_paradzhanova_052",
    name: "Магазин Параджанова 52",
    city: "Житомир",
    district: "Параджанова",
    address: "м. Житомир, вул. Параджанова, 52",
    aliases: ["Параджанова 52", "Параджанова,52", "Параджанова, 52", "магазин Параджанова 52"],
    objectType: "store",
  },
  {

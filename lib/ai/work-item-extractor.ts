...
function normalizeTitle(text: string) {
  ...
  if (/закріпит/u.test(value) && /плитк/u.test(value)) return "Закріпити чотири плитки на рампі";
  if (/(фасад|оновит|прокрасит)/u.test(value) && /(чорн|низ|фасад)/u.test(value)) return "Оновити фасад магазину та пофарбувати чорним низ";
  if (/пофарб/u.test(value) && /столик/u.test(value)) return "Пофарбувати два столики на вході магазину";

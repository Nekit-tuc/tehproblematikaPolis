...
import { Building2, CalendarDays, ClipboardList, FileCheck2, Home, Plus } from "lucide-react";
  ...
  if (profile.role === "store_director") {
    return (
      <nav className="fixed inset-x-0 bottom-0 z-40 px-4 pb-[max(env(safe-area-inset-bottom),0.75rem)] md:hidden">
        <div className="mx-auto grid h-[58px] max-w-md grid-cols-4 items-center rounded-t-[20px] border border-white/10 bg-[#090909]/90 px-1.5 shadow-[0_-14px_34px_rgba(0,0,0,0.68)] backdrop-blur-2xl">
          ...
          <MobileNavItem href="/director/acts" icon={FileCheck2} label="Акти" />
